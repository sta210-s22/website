...
Write the draft in the **written-report.Rmd** file in your project repo.
...
Each lab team will be assigned another team's project to review.
Each team should push their draft to their GitHub repo by **Tuesday, November 16**.
The lecture on Wednesday, November 17 be dedicated to the peer review, and all reviews will be **due by November 17 at 11:59pm**.

During the peer review process, you will be provided read-only access to your partner team's GitHub repo.
Provide your review in the form of GitHub issues to your partner team's GitHub repo.
...
Here is a *suggested* outline as you think through the slides; you [**do not**]{.ul} have to use this exact format for the 6 slides.
...
[Click here](https://prodduke-my.sharepoint.com/:x:/g/personal/mt324_duke_edu/EdJpsc-oSeZMp44DfunZJXoBHi-46BOCUh44JoILIoekMg?e=Up1ZJS) to see your viewing assignments.
...
You may start posting questions and comments on Friday, December 10.
**All comments must be posted by Saturday, December 11 at 11:59pm. (TO DO: UPDATE DATES)**
...
If you have concerns with the teamwork and/or contribution from any team members, please email me by Saturday, December 11 at 11:59pm with a brief description of your concerns.
