...
::: question
**Food for thought:** On the right are fits from various splits of the data into testing and training.
On the left are fits to bootstrap samples of the data.
Which one shows more variability and why?
:::
