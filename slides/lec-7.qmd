...
If the relationship between the response and the predictor variables is linear, the residuals vs. fitted values plot will not show a random scatter of residuals (no distinguishable pattern or structure)
...
df <- tibble(
  x = -49:50,
  e_curved = rnorm(100, 0, 150),
  y_curved = x^2 + e_curved,
  e_slight_curve = sort(rbeta(100, 5, 1)*200) + rnorm(100, 0, 5),
