...
ggplot(data = movie_scores, 
  ...
  geom_abline(intercept = 32.3155, slope = 0.5187, color = "red", size = 1) +
...
## Step 2: Fit model & estimate parameters
...
-   Fit a simple linear regression model in R and made a prediction.
