...
**Receiver operating characteristic (ROC) curve**[^1] which plot true positive rate vs. false positive rate (1 - specificity).

[^1]: Originally developed for operators of military radar receivers, hence the name.
