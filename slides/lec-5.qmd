...
-   Simulate to quantify the variability of the slope: - Bootstrap new samples from the original sample

<!-- -->

    -   Fit models to each of the samples and estimate the slope

    -   Calculate the variability of the slopes
...
::: columns
::: {.column width="50%"}
Does the data provide sufficient evidence that β1β1 is significantly different from 0?
:::
