...
To do this, first simulate the bootstrap distribution of the slope using 1,000 bootstrap samples.
...
-   $H_0$: There is no linear relationship between cost and admissions rate, $\beta_1 = 0$
-   $H_A$: There is a linear relationship between cost and admissions rate, $\beta_1 \ne 0$
