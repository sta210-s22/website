...
-   R will ask "No SSH key found.
    Generate one now?"
    You should click 1 for yes.

-   You will generate a key.
    It will begin with "ssh-rsa...." R will then ask "Would you like to open a browser now?"
    You should click 1 for yes.

-   You may be asked to provide your GitHub username and password to log into GitHub.
    After entering this information, you should paste the key in and give it a name.
    You might name it in a way that indicates where the key will be used, e.g., `sta210`).
...
<!--# INSERT SCREENSHOT OF IDE -->

Below are the components of a Quarto (.qmd) file.

<!--# INSERT SCREENSHOT OF QUARTO DOCUMENT -->
...
::: callout-warning
🧶 ✅ ⬆️ This is a good place to knit, commit, and push changes to your remote lab-1 repo on GitHub.
...
::: callout-caution
You will use the following data frame, `ikea_sub` for the remainder of the lab.
:::
...
::: callout-warning
🧶 ✅ ⬆️ You're done and ready to submit your work!
Knit, commit, and push all remaining changes.
You can use the commit message "Done with Lab 1!"
, and make sure you have committed and pushed all changed files to GitHub (your Git pane in RStudio should be empty) and that **all** documents are updated in your repo on GitHub.
...
-   Mark the pages associated with each exercise.
    All of the pages of your lab should be associated with at least one question (i.e., should be "checked").
